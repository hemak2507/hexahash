...
ErrorDialog.title = _t("App Error");
...
ClientErrorDialog.title = _t("App Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("App Network Error");
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("App Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || _t("App Warning");
        this.message = message;
...
SessionExpiredDialog.title = _t("App Session Expired");
