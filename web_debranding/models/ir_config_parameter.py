...
PARAMS = [
    ("web_debranding.new_name", _("Firebridge")),
    ("web_debranding.new_title", _("Firebridge")),
    ("web_debranding.new_website", "firebridge.co.za"),
    ("web_debranding.new_documentation_website", "https://firebridge.co.za//"),
